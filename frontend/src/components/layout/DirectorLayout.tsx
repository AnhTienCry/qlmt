...
const menuItems = [
  ...
  {
    label: 'Duyệt đề xuất',
    path: ROUTES.DIRECTOR_PROPOSALS,
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div className="min-h-screen bg-[#0f0f0f]">
      ...
      >
        ...
        <div className={`flex items-center h-16 px-4 border-b border-[#2e2e2e] flex-shrink-0 ${sidebarOpen ? 'justify-between' : 'justify-center'}`}>
          {sidebarOpen ? (
            <>
              <Link to={ROUTES.DIRECTOR_DASHBOARD} className="flex items-center gap-3">
            ...
            <button
              onClick={() => setSidebarOpen(!sidebarOpen)}
              className="w-10 h-10 bg-purple-600 rounded-lg flex items-center justify-center hover:bg-purple-700 transition"
            >
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />
              </svg>
        ...
        <div className="flex-shrink-0 p-4 border-t border-[#2e2e2e] bg-[#1a1a1a]" ref={dropdownRef}>
          <div className={`flex items-center ${sidebarOpen ? 'gap-3' : 'justify-center'} relative`}>
            <button
              ...
              className={`w-10 h-10 bg-purple-600 rounded-full flex items-center justify-center flex-shrink-0 ${!sidebarOpen ? 'cursor-pointer hover:ring-2 hover:ring-purple-400' : ''}`}
            >

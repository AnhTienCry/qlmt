        ...
        <div className="flex-shrink-0 p-4 border-t border-[#2e2e2e] bg-[#1a1a1a]" ref={dropdownRef}>
          <div className={`flex items-center ${sidebarOpen ? 'gap-3' : 'justify-center'} relative`}>
            <button
              ...
              className={`w-10 h-10 bg-green-600 rounded-full flex items-center justify-center flex-shrink-0 ${!sidebarOpen ? 'cursor-pointer hover:ring-2 hover:ring-green-400' : ''}`}
            >
